        ...
        <div class="panel-body">
            <form role="form">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" name="staff_number" value="{{ $data->staff_number }}" disabled>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                        ...
                        <input class="form-control" name="national_id_number" value="{{ $data->national_id_number }}" disabled>
                    </div>
                </div>
                ...
                <a href="/administrator/{{ $data->id}}/edit" class="btn btn-default">Edit Record</a>
