...
@section('content')
    ...
    <div>
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('student_allocation.index') }}">Student Class Allocation</a></li>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form role="form" method="POST" action="{{route('student_allocation.store')}}">
                @csrf
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" name="student_id">
                        @foreach($students as $student)
                            <option value="{{ $student->user_id }}" selected>{{ $student->student_number->student_number }} - {{ $student->fname.' '.$student->oname.' '.$student->sname }}</option>
                        @endforeach
                    </select>
                </div>
